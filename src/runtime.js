...
const { feynmanCore } = require('feynman-smartdb')
...
async function loadModels(dir) {
  ...
  modelFiles.forEach((modelFile) => {
    ...
    schemas.push(new feynmanCore.ModelSchema(schema, modelName))
  })
...
function adaptSmartDBLogger(config) {
  ...
  feynmanCore.LogManager.logFactory = {
...
module.exports = async function runtime(options) {
  ...
  app.sdb = new feynmanCore.SmartDB(BLOCK_DB_PATH, BLOCK_HEADER_DIR)
